...
// ________________________________________________________________ settings _______________________________________________________
    ...
    var first_color_green = 255;
    var first_color_blue = 255;
   
    var second_color_red = 216;
    var second_color_green = 216;
    var second_color_blue = 216;
    // ________________________________________________________________________________
    
    
    var n_bars = 10;
    var n_components_per_bar = 10;
    
    var bar_margin = 5;
    
    var bar_component_margin = 2; 
    
    var frequency = 5;  // the frequency of the equalizer, don't set a value above 20 or you'll consume a high CPU
    var refresh_time = 120;  // the refresh time for the equalizer
